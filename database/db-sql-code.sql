...
-- Create account table WITH ENUM type
...
-- Insert inventory data (from inventory-data.txt)
...
-- Assignment 2 queries (4 and 6) added at the end as required
...
-- Query 6: Add '/vehicles' to image paths
UPDATE public.inventory
SET
  inv_image = REPLACE(inv_image, '/images', '/images/vehicles'),
  inv_thumbnail = REPLACE(inv_thumbnail, '/images', '/images/vehicles');

-- Insert test accounts with different account types
INSERT INTO public.account (
  account_firstname, account_lastname, account_email, account_password, account_type
) VALUES 
  ('John', 'Client', 'client@test.com', 'hashed_password_1', 'Client'),
  ('Jane', 'Employee', 'employee@test.com', 'hashed_password_2', 'Employee'),
  ('Bob', 'Admin', 'admin@test.com', 'hashed_password_3', 'Admin');