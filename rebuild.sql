...
-- Insert inventory data (from your provided .txt snippet)
...
-- Update query 4: Replace 'small interiors' with 'a huge interior' in Hummer description
UPDATE public.inventory
SET inv_description = REPLACE(inv_description, 'small interiors', 'a huge interior')
WHERE inv_make = 'GM' AND inv_model = 'Hummer';

-- Update query 6: Update image paths to include '/vehicles'
UPDATE public.inventory
SET
